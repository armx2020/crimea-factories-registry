...
- **16.10.2025**: Добавлен фильтр "Принадлежность к сети" (В сети / Отдельные заводы)
- **16.10.2025**: Добавлена поддержка Ctrl+V для загрузки логотипа сети (подсказка в форме)
...
- **16.10.2025**: Полностью переработана адаптивность для мобильных устройств:
  - Убраны все горизонтальные скроллы
  - Оптимизированы размеры элементов для маленьких экранов
  - Улучшены карточки заводов и сетей (адаптивные размеры текста, отступы)
  - Формы добавления/редактирования адаптированы для мобильных
  - Навигация оптимизирована для маленьких экранов
  - Все диалоги и модальные окна адаптированы (95vw для мобильных)
